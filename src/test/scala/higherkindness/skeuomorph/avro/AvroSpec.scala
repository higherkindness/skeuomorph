...
//      useIdiomaticEndpoints: Boolean = fale
//  ): String = {
...
//    val resourceName  = s"avro/${idlName}.scala"
//    val template = TemplateSource.fromFile(new File(getClass.getResource(resourceName).toURI))
//    templateEngine.layout(template, Map[String, Any]())
