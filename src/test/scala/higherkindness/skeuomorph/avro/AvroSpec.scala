...
class AvroSpec extends Specification with ScalaCheck {
  ...
  def codegenExpectation(compressionType: CompressionType, useIdiomaticEndpoints: Boolean): String = {
    ...
    s"""package foo.bar
      ...
      |final case class LogicalIdl(dec: _root_.shapeless.tag.@@[_root_.shapeless.tag.@@[_root_.scala.math.BigDecimal, ("precision", 20)], ("scale", 8)], maybeDec: _root_.scala.Option[_root_.shapeless.tag.@@[_root_.shapeless.tag.@@[_root_.scala.math.BigDecimal, ("precision", 20)], ("scale", 8)]], ts: _root_.java.time.Instant, dt: _root_.java.time.LocalDate)
