...
//}
//
//class PackageDescriptor private[protobuf] (val fullName: String) extends BaseDescriptor {
//  override def toString: String = fullName
//}
//
//class Descriptor private[protobuf] (
//    val fullName: String,
...
//
//  lazy val oneofs: Seq[OneofDescriptor] = asProto.oneofDecl.toVector.zipWithIndex.map {
//    case (oneof, index) =>
//      val oneofFields = fields.filter { t =>
//        t.asProto.getOneofIndex.isDefined && t.asProto.oneofIndex.get == index
//      }
...
//}
//
//class EnumDescriptor private[protobuf] (
//    val fullName: String,
...
//}
//
//class EnumValueDescriptor private[protobuf] (
//    val fullName: String,
...
//}
//
//class FieldDescriptor private[protobuf] (
...
//  private[protobuf] def buildFieldDescriptor(
...
//}
//
//class OneofDescriptor private[protobuf] (
//    val fullName: String,
//    val containingMessage: Descriptor,
...
//}
//
//class FileDescriptor private[protobuf] (
...
//
//  private[protobuf] def join(a: String, b: String) = if (a.isEmpty) b else (a + "." + b)
//
//  private[protobuf] def parentOf(context: String) = {
...
//
//  @tailrec
//  private[protobuf] def nameChain(fullName: String, acc: List[String] = Nil): List[String] = {
...
//}
//
//class ConcurrentWeakReferenceMap[K, V <: AnyRef] {
